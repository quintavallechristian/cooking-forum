...
class TestClass(unittest.TestCase):
    ...
    def test_verify_otp(self):
        with self.app.app_context():
            ...
            response = self.client.post(
                "/api/verify",
                json={"email": theMail, "password": "testPassword", "otp": "123456"},
            )
    ...
    def test_missing_user_login(self):
        with self.app.app_context():
            response = self.client.post(
                "/api/login", json={"email": "wrong_email", "password": "wrong_psw"}
            )
    ...
    def test_missing_params_verify(self):
        with self.app.app_context():
            response = self.client.post(
                "/api/login", json={"email": "wrong_email", "passowrd": "testPassword"}
            )
    ...
    def test_wrong_credentials_login(self):
        with self.app.app_context():
            ...
            response = self.client.post(
                "/api/login", json={"email": theMail, "password": "wrong_psw"}
            )
    ...
    def test_wrong_verify_otp(self):
        with self.app.app_context():
            ...
            response = self.client.post(
                "/api/verify",
                json={"email": theMail, "password": "testPassword", "otp": "000000"},
            )
    ...
    def test_wrong_email_format_signup(self):
        with self.app.app_context():
            ...
            user = User.query.filter_by(email=fake.email()).first()
            assert user == None
            assert "error" in response.get_json()
    ...
    def test_logged_in_route(self):
        with self.app.app_context():
            ...
            response = self.client.post(
                "/api/login", json={"email": myMail, "password": "testPassword"}
            )
